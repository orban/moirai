...
| File | Change |
|------|--------|
| `scripts/convert_eval_harness.py` | JSONL parsing, reasoning extraction, `--transcripts` flag |
| `moirai/analyze/narrate.py` | Add reasoning fields to StepDetail and BranchExample |
| `moirai/viz/html.py` | Fork cards, dendrogram+heatmap, remove decision trees + flat matrix |
